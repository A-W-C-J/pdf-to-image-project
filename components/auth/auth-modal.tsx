        ...
        <div className="space-y-4">
          <Auth
            ...
            appearance={{
              ...
              className: {
                container: 'space-y-4',
                button: 'w-full px-4 py-2 rounded-md font-medium transition-colors hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
                input: 'w-full px-3 py-2 border rounded-md bg-background text-foreground border-input hover:border-accent focus:border-ring focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
